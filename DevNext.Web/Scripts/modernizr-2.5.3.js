...
window.Modernizr = (function( window, document, undefined ) {
    ...
    /**
      * isEventSupported determines if a given element supports the given eventInfo
    ...
    // Modernizr.hasEvent() detects support for a given eventInfo, with an optional element to test on
    ...
    // If you're trying to ascertain which transition end eventInfo to bind to, you might do something like...
    // 
