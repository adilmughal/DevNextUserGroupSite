...
$.extend($.validator, {
	...
	defaults: {
		...
		ignore: ":hidden",
		ignoreTitle: false,
		onfocusin: function(element, eventInfo) {
		...
		onfocusout: function(element, eventInfo) {
			if ( !this.checkable(element) && (element.name in this.submitted || !this.optional(element)) ) {
				this.element(element);
			}
		},
		onkeyup: function(element, eventInfo) {
			if ( element.name in this.submitted || element == this.lastElement ) {
				this.element(element);
			}
		},
		onclick: function(element, eventInfo) {
	...
	prototype: {
		...
		init: function() {
			...
			function delegate(eventInfo) {
				...
				validator.settings[eventType] && validator.settings[eventType].call(validator, this[0], eventInfo);
			}
			$(this.currentForm)
