...
{
    public class DevNextDbContextCreateDatabaseIntializer : CreateDatabaseIfNotExists<DevNextDbContext>
    {
        protected override void Seed(DevNextDbContext context)
        {
            ...
            context.TechnicalContents.Add(new TechnicalContent
                {
            ...
            context.TechnicalContents.Add(new TechnicalContent
                {
                    ...
                    Url = @"http://edotnetdevs.wordpress.com/2011/10/30/event-summary-oct-ug-meeting-on-design-principles-and-practices/",
            ...
            context.TechnicalContents.Add(new TechnicalContent
                {
                    ...
                    Url = @"http://edotnetdevs.wordpress.com/2010/12/04/event-summary-visual-studio-2010-ultimate-loadfest/",
    ...
    public class DevNextDbContextDropAndCreateDatabaseIfModelChangesIntializer : DropCreateDatabaseIfModelChanges<DevNextDbContext>
    {
        protected override void Seed(DevNextDbContext context)
        {
            if (!WebSecurity.Initialized)
